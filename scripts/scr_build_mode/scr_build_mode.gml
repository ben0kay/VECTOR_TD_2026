...
function scr_build_mode_preview_update(
    _controller
)
{
    if (!instance_exists(_controller))
    ...
    // Centre multi-cell buildings around their complete footprint.
...
function scr_build_mode_update(
    _controller
)
{
    if (!instance_exists(_controller))
