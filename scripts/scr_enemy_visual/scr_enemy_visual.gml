...
/// @description Updates temporary enemy shield visual feedback.

function scr_enemy_shield_visual_update(_enemy)
{
    if (!instance_exists(_enemy))
        return false;
...
/// @description Draws one enemy's primitive vector shield.
...
function scr_enemy_shield_draw(_enemy)
{
    ...
    // Partial outer arcs communicate remaining shield strength.
